...
public class YTAPI {
    ...
    public void schedulePreviewDownload(final String url, final String cacheName, final PreviewCallback callback)
    {
    ...
    public void request(final String method, final Callback runnable)
    {
